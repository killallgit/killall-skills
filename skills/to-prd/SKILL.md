...
1. Read `docs/agents/issue-tracker.md` first if it exists. Treat its frontmatter as the contract for where PRDs live and which store is canonical. If the file is missing or ambiguous, run `/setup-skills`.
