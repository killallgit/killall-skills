...
Read `docs/agents/issue-tracker.md` first if it exists. Treat its frontmatter as the contract for where issue slices should be published and which store is canonical. If the file is missing or ambiguous, run `/setup-planning`.
