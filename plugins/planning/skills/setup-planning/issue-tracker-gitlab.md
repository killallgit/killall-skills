...
- **Child ticket**: an issue carrying `Part of #<map>` at the top of its description and labels `wayfinder:<type>` (`research`/`prototype`/`discussion`/`task`). Once claimed, the ticket is assigned to the driving dev.
