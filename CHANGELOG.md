...
* add reusable baseline programming rules for global agent configuration
* package planning, engineering, knowledge, and experimental skills as portable
  domain plugins in the `killallgit` Codex marketplace
