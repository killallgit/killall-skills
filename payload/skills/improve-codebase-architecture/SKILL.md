...
- **Naming a deepened module after a concept not in `docs/CONTEXT.md`?** Add the term there — same discipline as `/grill-with-docs` (see [CONTEXT-FORMAT.md](../domain-modeling/CONTEXT-FORMAT.md)). Create the file lazily if it doesn't exist.
