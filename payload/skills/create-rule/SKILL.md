---
name: create-rule
description: Create or update an installable reusable rule under `payload/rules/` without mixing it with repository-maintenance instructions.
---
...
2. Create or update a focused Markdown file under `payload/rules/`.
