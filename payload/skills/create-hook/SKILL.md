---
name: create-hook
description: Create or update tool-agnostic hook instructions or hook scripts under `hooks/` while keeping host payload separate from repo-authored instructions.
---

# Create Hook

Use this when the user wants to add hook behavior to the installable skill pack.
...
3. If adding a script, place it under `hooks/<phase>/` with a numeric
   prefix, such as `10-review-library-usage.sh`.
